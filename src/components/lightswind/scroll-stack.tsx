...
const ScrollStack: React.FC<ScrollStackProps> = ({
  ...
  >
    ...
    >
      <div
        className={`sticky top-0 w-full h-screen flex items-center justify-center overflow-hidden bg-[#3B3D40]`}
      >
                  ...
                  <div className="relative z-10 p-5 sm:p-6 md:p-8 h-full flex items-center">
                    {card.content ? (
                      ...
                      <div className="max-w-lg">
                        <h3 className="text-2xl sm:text-3xl md:text-4xl font-bold text-[#403635] leading-tight mb-4">
                          {card.title}
                        </h3>
                        {card.subtitle && (
                          <p className="text-lg text-[#403635]/80">{card.subtitle}</p>
                        )}
                      </div>
                    )}
                  </div>
